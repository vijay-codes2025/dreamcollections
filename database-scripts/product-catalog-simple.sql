-- Product Catalog Service Database Sample Data (PostgreSQL) - Simplified
...
-- Women's Earrings (One Size)
(25, 7, 'One Size', 30),
(26, 8, 'One Size', 25),
(27, 9, 'One Size', 40),

-- Women's Bracelets (Small, Medium, Large)
(28, 10, 'Small (6.5")', 8),
(29, 10, 'Medium (7")', 12),
(30, 10, 'Large (7.5")', 6),
(31, 11, 'Small (6.5")', 20),
...
-- Kids Necklaces (12", 14", 16" lengths - shorter for kids) ⭐ KIDS COLLECTION
(52, 16, '12 inches', 25),
(53, 16, '14 inches', 30),
(54, 16, '16 inches', 20),
(55, 17, '12 inches', 35),
...
-- Kids Earrings (Different colors)
(67, 22, 'Pink', 25),
(68, 22, 'Purple', 30),
(69, 22, 'Blue', 20),
(70, 22, 'Yellow', 15),
...
WHERE c.name = 'Kids Collection' OR c.parent_category_id = 3
